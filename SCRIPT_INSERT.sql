...
INSERT INTO
	...
	VALUES
	(2,				1,					GETDATE()-10,	GETDATE()-3,	49.95),

	(3,				2,					GETDATE()+5,	GETDATE()+20,	99.90),

	(4,				12,					GETDATE()+3,	NULL,			249.85),

	(5,				1,					GETDATE()-7,	GETDATE(),		149.85),
	
	(6,				3,					GETDATE()-1,	NULL,			49.95),

	(7,				5,					GETDATE()+5,	GETDATE()+20,	99.90),

	(8,				8,					GETDATE()+2,	NULL,			249.85),

	(9,				2,					GETDATE()-15,	GETDATE()-1,	149.85);
